...
LIBS=utils,errors,config,zod,ic-client,storage,auth,cdn,config-loader,core,admin,analytics,core-peer,core-standalone,functions,functions-tools,cli-tools
