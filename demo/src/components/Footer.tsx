    ...
    <footer className="mx-auto flex h-24 max-w-(--breakpoint-2xl) items-center justify-between px-8 py-16 md:justify-start md:gap-24 md:px-24 dark:text-white">
      <span className="flex items-baseline gap-2">
        <a
          ...
          className="group hover:text-lavender-blue-500 active:text-lavender-blue-400"
          target="_blank"
        ...
        >
          ...
          >
            <g>
              ...
              <circle
                className="cls-1 fill-lavender-blue-500 group-hover:fill-black group-active:fill-black dark:group-hover:fill-white dark:group-active:fill-white"
                cx="931.86"
                cy="68.14"
                r="68.14"
              ></circle>
            ...
            <g>
              <g>
                <g>
                  ...
                  <path d="M19.32,22.57c-1.76.21-3.02,1.8-2.81,3.56.17,1.48,1.34,2.64,2.81,2.81,1.66-.1,2.93-1.53,2.84-3.19.1-1.66-1.16-3.08-2.82-3.18,0,0-.01,0-.02,0"></path>
                  <path d="M29.82,22.57c-1.76-.2-3.35,1.06-3.56,2.82-.2,1.76,1.06,3.35,2.82,3.56s3.35-1.06,3.56-2.82c.01-.12.02-.25.02-.37.09-1.66-1.18-3.09-2.84-3.19"></path>
                </g>
              </g>
            </g>
          </svg>
