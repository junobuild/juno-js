...
describe('arrays-utils', () => {
  ...
  it('should convert bigint to Uint8Array and back to bigint', () =>
    expect(uint8ArrayToBigInt(bigIntToUint8Array(1555628690182n))).toEqual(1555628690182n));
  ...
  it('should convert ascii string to byte array', () => {
    const expectedResult = [55, 49, 49, 48, 49, 49, 48, 49, 49, 48, 55, 49, 49, 53];
  ...
  it('should convert Candid Nat to BigInt', () => {
    ...
    expect(
      candidNumberArrayToBigInt([
        3735344374, 914506646, 1139096947, 3625449072, 77510495, 1540130702, 55083
      ])
