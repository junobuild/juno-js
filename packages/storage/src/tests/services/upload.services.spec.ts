...
import {uploadAsset} from '../../services/upload.services';
import {type UploadAsset, UploadAssetActor} from '../../types/upload';
...
describe('uploadAsset', () => {
  ...
  const makeActorMocks = (): {
    ...
    return {actor, commit_asset_upload, upload_asset_chunk, init_asset_upload};
  };
