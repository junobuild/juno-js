...
describe('openid.utils', () => {
  describe('isFedCMSupported', () => {
    ...
    it('returns true when IdentityCredential exists and UA is not Samsung', () => {
    ...
    it('returns false when IdentityCredential is missing', () => {
    ...
    it('returns false on Samsung Browser even if IdentityCredential exists', () => {
      vi.stubGlobal('IdentityCredential', class {});
      setUA(
    ...
    it('returns false on SamsungBrowser match regardless of case', () => {
      vi.stubGlobal('IdentityCredential', class {});
